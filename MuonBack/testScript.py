...
try:
        opts, args = getopt.getopt(sys.argv[1:], "D:FHPu:n:i:f:c:hqv:s:l:A:Y:i:m:co:t:F",[\
                                   "PG","Pythia6","Pythia8","Genie","MuDIS","Ntuple","Nuage","MuonBack","FollowMuon","Field=",\
...
if myField: 
 print "+++ Setting field of muon shield to ",myField 
 ship_geo.muShield['Field'] = myField
